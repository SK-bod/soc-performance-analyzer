...
# Thu Jan 18 22:10:00 CET 2024
# DO NOT MODIFY


# 
# SK_module "SK_module" v1.0
# Stanislaw Krol 2024.01.18.22:10:00
# Module used for generating timestamps and storing them in DP-RAM
# 
...
# module SK_module
# 
set_module_property DESCRIPTION "Module used for generating timestamps and storing them in DP-RAM"
set_module_property NAME SK_module
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property AUTHOR "Stanislaw Krol"
set_module_property DISPLAY_NAME SK_module
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL SK_module
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property QUARTUS_SYNTH ENABLE_FILE_OVERWRITE_MODE false
add_fileset_file SK_module.vhd VHDL PATH SK_module/SK_module.vhd TOP_LEVEL_FILE
...
set_interface_property avalon_slave_2 associatedReset reset
...
add_interface_port avalon_slave_2 write_data writedata Input 64
add_interface_port avalon_slave_2 write write Input 1
add_interface_port avalon_slave_2 write_address address Input 9
...
add_interface_port avalon_slave_1 read_data readdata Output 32
add_interface_port avalon_slave_1 read_address address Input 8
