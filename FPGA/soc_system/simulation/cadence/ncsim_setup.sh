...
# ACDS 18.1 625 win32 2024.01.14.00:27:57
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_pio_led.v"                                                  -work pio_led                                                          -cdslib ./cds_libs/pio_led.cds.lib                                                         
